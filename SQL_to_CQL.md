...
## Stats Values
Description: Stats values can be used to help sumarize unique values in a field, giving summary context of unique commandline executions for example in a simmple easy readable format. In CQL the equivalent is collect()
